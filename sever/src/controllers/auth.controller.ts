...
export const verifyEmail = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    const updatedUser = await prisma.user.update({
      where: { id: user.id },
      data: { isVerified: true, verificationToken: null, otpExpires: null },
    });
...
export const forgotPassword = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    await prisma.user.update({
      where: { email },
      data: { verificationToken: token, otpExpires: tokenExpires },
    });
...
export const resendOtp = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    await prisma.user.update({
      where: { email },
      data: { verificationToken: otp, otpExpires },
    });
...
export const resendVerificationOtp = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    await prisma.user.update({
      where: { email },
      data: { verificationToken: token, otpExpires },
    });
...
export const verifyResetOtp = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    await prisma.user.update({
      where: { email },
      data: { verificationToken: null, otpExpires: null },
    });
